...
@if (session('alert'))
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            {!!Form::open(array('url'=>'programas','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}}
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="input-group">
                ...
                <input type="text" name="PROG_ID" required value="{{old('PROG_ID')}}" class="form-control" placeholder="ID Programa">
            </div>
        </div>
